...
const TrackDetail = ({ track }) => {
  //  NOTE: Job commented out the old track VALUES
    ...
    <ContentSection>
      ...
      <TrackDetails>
        ...
        <DetailRow>
          ...
          <DetailItem>
            <h4>Author</h4>
            <AuthorImage src={description.photo} />
            <AuthorName>{description.name}</AuthorName>
          </DetailItem>
          <div>
